...
public class DragCreatureAttack : DraggingActions {
    ...
    public override void OnStartDrag()
    {
        ...
        lr.enabled = true;
        CreatureLogic[] enemies = TurnManager.Instance.whoseTurn.otherPlayer.table.CreaturesOnTable.ToArray();
        foreach (CreatureLogic cl in enemies)
        {
            if (cl.hasTaunt)
            {
                enemiesWithTaunt++;
        ...
        Debug.Log("Enemies with Taunt " + enemiesWithTaunt);
    }
